...
const LatestUpdate = ({ hideKnowMore = false }) => {
  ...
  return (
    <section className="latest-update pseudo-animate">
      <div className="container">
        ...
        {!hideKnowMore && (
          <div className="btn-wrap">
            <a className="btn-primary" href="/blogs">Know More<span>
